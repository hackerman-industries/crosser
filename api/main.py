...
def get_journeys(start_pos, end_pos, journey_date):
    """
...
def get_all_journeys(services, journey_date):
    """
    Returns a list of all possible impacting journeys.
...
# Testing
j = get_all_journeys(SERVICES, "2022/08/19")

for journey in j:
    print(f"Journey from {journey.origin} to {journey.destination}, \
departing at {journey.departure_time} & arriving at {journey.arrival_time}")
